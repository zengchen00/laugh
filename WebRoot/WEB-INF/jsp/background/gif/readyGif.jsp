	...
	<div class="row" style="margin-top: 4rem;">
		<div class="col-md-3">
			<ul class="list-group">
			  ...
			  <li class="list-group-item" style="text-indent: 1.5rem;">
			    <a href="${pageContext.request.contextPath}/background/readyGif.html" style="color:#68228B;">待上线gif文章列表</a>
			  </li>
			  <li class="list-group-item" style="text-indent: 1.5rem;">
		...
		<div class="col-md-9">
			<table id="table" class="table table-striped table-condensed">
			  ...
			  <tr>
					...
					<button id="online" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-primary" onclick="onlineTip(${item.id})">上线</button>
...
function onlineTip(articleId){
	var url = "${pageContext.request.contextPath}/background/onlineArticle.html";
	$("#tipContent").text("确定上线吗？");
	$("#confirmDiv").show();

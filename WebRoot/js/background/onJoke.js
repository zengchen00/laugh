$(function(){
	...
	buttonStr = buttonStr + '<button onclick="changeState(2)" class="btn btn-white btn-default btn-bold" style="margin-right: 4px;"><i class="ace-icon fa fa-bolt bigger-120 orange"></i>上线</button>';
